    ...
    <>
      ...
      <div className="w-full mt-10 md:mt-[159px] mb-0 container p-4 md:p-0">
        <div className="w-full flex flex-col md:pl-10 md:flex-row">
          <div className="w-full md:w-[520px] flex flex-col items-center md:text-left pt-[56px] px-0">
            <p className="w-full md:w-[430px] md:h-[128px] text-3xl md:text-5xl font-semibold m-0 text-center md:leading-[60px] tracking-[1px] text-oxford-blue">
              Clinic & beauty consultant
            </p>
            <p className="w-full md:w-[474px] md:h-[54px] text-xs md:text-base font-medium md:leading-6 tracking-widest text-custom-gray text-center m-0">
