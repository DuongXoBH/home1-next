    ...
    <>
      ...
      <div className="w-full flex !mt-[129px] container">
        <div className="w-[664px] h-[292px]">
          <p className="w-[73px] h-5 text-base font-semibold leading-5 text-left text-custom-pink m-0">
            About Us
          </p>
          <p className="w-[664px] h-[52px] text-4xl font-semibold leading-[45px] text-left text-[rgba(9,17,86,1)] !tracking-[0.3px] mt-3 mb-0 mx-0">
          ...
          <div className="flex w-[424px] h-[60px] mt-[52px] justify-between">
            <button className="w-[200px] h-[58px] text-[antiquewhite] bg-custom-pink text-base font-semibold leading-6 tracking-widest text-center mr-1.5 rounded-[50px] border-0">
              Learn More
            </button>
