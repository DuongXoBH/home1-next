...
export interface IQuestionInput {
  questionInfomation: IQuestion[];
}

export default function FaqBoxComponent(props: IQuestionInput) {
  ...
  return (
    <div className="w-full md:w-[972px] mx-auto mt-10 md:mt-[90px] flex flex-col justify-center">
      {props.questionInfomation.map((element, index) => (
        <div
          className="w-full flex flex-col items-center mb-[30px]"
          key={`question_${index}`}
        >
          <div onClick={() => toggleActive(index)} className="w-full flex justify-between md:pl-8 md:pr-5 md:items-start">
          ...
          <div
            ...
            className = {
              classNames({
                ...
                'flex flex-col md:h-[216px]': index === activeIndex,
